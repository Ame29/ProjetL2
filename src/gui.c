 ...
 * \brief Permet de créer la matrice de jeu (sa forme graphique à l'aide de bouton Gtk) en utilisant les fonctions de la librarie fonctionGrille.c Permet de créer la matrice jeu à partir d'une sauvegarde. Crée le chronomètre et l'initialise à zéro.
