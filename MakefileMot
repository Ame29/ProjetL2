...
./bin/MotsMeles : manipmatrice.o  manipDirectionPlacement.o maniphasard.o main.o
	gcc manipmatrice.o  manipDirectionPlacement.o maniphasard.o main.o -o ./bin/MotsMeles ${OPTS}
